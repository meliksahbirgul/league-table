...
<div class="container">
    ...
    @if($standing)
        <div class="standings-box">
            <div class="col-md-8">
                <h2 class="standings-box_title">Standings</h2>
                    ...
                    <table id="standings-table" class="table table-bordred table-striped">
                        ...
                        @foreach($standing as $team)
                            <tr>
                                ...
                                <td class="standings_team_name">{{$team->points}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
            ...
            <div class="row prediction-wrapper">
                ...
                <table class='table table-info make-full-width'>
                    <thead>
                    <tr>
            ...
            <div class="row">
                <h3 class="make-center make-full-width simulation-box_title">Simulation Managements</h3>
                <div class="make-center make-full-width">
                    <button class="btn simulate-all-weeks">
                        Simulate
                        All
                        Weeks
                    </button>
                                ...
                                <tr>
                                    <td class="make-center">
                                        <img width="30" height="30"
                                             src="{{asset('images/home_team.png')}}">
                                        {{$fixture['home_team']}}
                                    </td>
                                    ...
                                    <td class="make-center">
                                        <img width="30" height="30"
                                             src="{{asset('images/away_team.png')}}">
                                        {{$fixture['away_team']}}
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <tr>
                            @if($fixture['status'] == 0)
                                <td colspan="5" class="make-center weekly-simulate-button">
                                    <button data-week="{{$week->id}}" class="btn btn-warning play-week">
